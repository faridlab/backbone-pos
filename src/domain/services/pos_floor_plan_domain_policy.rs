//! Domain policy for PosFloorPlan aggregate
//!
...
/// Domain policy for PosFloorPlan — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PosFloorPlan>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PosFloorPlanDomainPolicy = PermitAllPolicy<PosFloorPlan>;
