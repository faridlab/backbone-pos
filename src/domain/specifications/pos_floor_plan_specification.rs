//! Specifications for PosFloorPlan aggregate
//!
...
// Each predicate implements `Specification<PosFloorPlan>` and can be combined
...
//
// pub struct ActivePosFloorPlanSpec;
// impl Specification<PosFloorPlan> for ActivePosFloorPlanSpec {
//     fn is_satisfied_by(&self, e: &PosFloorPlan) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
