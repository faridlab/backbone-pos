//! Specifications for PosProfile aggregate
//!
...
// Each predicate implements `Specification<PosProfile>` and can be combined
...
//
// pub struct ActivePosProfileSpec;
// impl Specification<PosProfile> for ActivePosProfileSpec {
//     fn is_satisfied_by(&self, e: &PosProfile) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
