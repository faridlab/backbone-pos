//! Specifications for PosInvoiceItem aggregate
//!
...
// Each predicate implements `Specification<PosInvoiceItem>` and can be combined
...
//
// pub struct ActivePosInvoiceItemSpec;
// impl Specification<PosInvoiceItem> for ActivePosInvoiceItemSpec {
//     fn is_satisfied_by(&self, e: &PosInvoiceItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
