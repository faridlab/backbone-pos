//! Specifications for PosOpeningEntry aggregate
//!
...
// Each predicate implements `Specification<PosOpeningEntry>` and can be combined
...
//
// pub struct ActivePosOpeningEntrySpec;
// impl Specification<PosOpeningEntry> for ActivePosOpeningEntrySpec {
//     fn is_satisfied_by(&self, e: &PosOpeningEntry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
