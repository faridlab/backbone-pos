//! Specifications for PosCashMovement aggregate
//!
...
// Each predicate implements `Specification<PosCashMovement>` and can be combined
...
//
// pub struct ActivePosCashMovementSpec;
// impl Specification<PosCashMovement> for ActivePosCashMovementSpec {
//     fn is_satisfied_by(&self, e: &PosCashMovement) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
