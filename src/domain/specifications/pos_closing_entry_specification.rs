//! Specifications for PosClosingEntry aggregate
//!
...
// Each predicate implements `Specification<PosClosingEntry>` and can be combined
...
//
// pub struct ActivePosClosingEntrySpec;
// impl Specification<PosClosingEntry> for ActivePosClosingEntrySpec {
//     fn is_satisfied_by(&self, e: &PosClosingEntry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
