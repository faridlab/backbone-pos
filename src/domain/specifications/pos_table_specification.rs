//! Specifications for PosTable aggregate
//!
...
// Each predicate implements `Specification<PosTable>` and can be combined
...
//
// pub struct ActivePosTableSpec;
// impl Specification<PosTable> for ActivePosTableSpec {
//     fn is_satisfied_by(&self, e: &PosTable) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
