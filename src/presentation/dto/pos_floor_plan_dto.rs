//! PosFloorPlan DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new PosFloorPlan
///
...
/// Request DTO for full update of a PosFloorPlan
///
...
/// Request DTO for partial update of a PosFloorPlan
///
...
/// Response DTO for PosFloorPlan entity
///
...
/// Paginated list response for PosFloorPlan entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct PosFloorPlanListResponseDto {
    /// List of items
    pub items: Vec<PosFloorPlanResponseDto>,
...
impl PosFloorPlanListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<PosFloorPlanResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<PosFloorPlan> for PosFloorPlanResponseDto {
...
impl From<PosFloorPlan> for PosFloorPlanSummaryDto {
    fn from(entity: PosFloorPlan) -> Self {
...
impl From<CreatePosFloorPlanDto> for PosFloorPlan {
...
impl backbone_core::FromCreateDto<CreatePosFloorPlanDto> for PosFloorPlan {
    fn from_create_dto(dto: CreatePosFloorPlanDto) -> backbone_core::ServiceResult<Self> {
        Ok(PosFloorPlan::from(dto))
    }
}
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to PosFloorPlan here.
