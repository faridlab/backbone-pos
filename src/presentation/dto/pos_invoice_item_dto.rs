...
impl PatchPosInvoiceItemDto {
    ...
    pub fn has_changes(&self) -> bool {
        self.pos_invoice_id.is_some() || self.item_id.is_some() || self.description.is_some() || self.quantity.is_some() || self.unit_price.is_some() || self.discount_amount.is_some() || self.net_amount.is_some() || self.revenue_account_id.is_some()
    }
}
